        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 hidden-xs">
                    ...
                    <tbody>
                        ...
                        foreach ($carts as $cart) {
                            ...
                            <tr>
                                ...
                                <td class="col-lg-2 col-md-2 col-sm-2 col-xs-2 text-center price total_<?= $cart->id ?>">AED <?= $total . '.00' ?></td>
                ...
                <div class="lit-blue sub-total">
                    <div class="col-md-12"><h4>Subtotal:<span class="price subtotal">AED <?= $subtotal . '.00' ?></span></h4></div>
                    ...
                    <div class="media">
                        ...
                        <div class="col-xs-12 item-total">
                            ...
                            <div class="col-xs-7 amount">
                                <?php $total = $price * $cart->quantity; ?>
                                <p class="text-right total_<?= $cart->id ?>">AED <?= $total . '.00' ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
