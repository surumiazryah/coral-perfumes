...
//$category_main = $_GET['category'];
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <?php if (!empty($prod_main_catag)) { ?>
                                        ...
                                        <li class="<?= $prod_main_catag->main_category == 2 ? 'active' : '' ?>"><?= Html::a('<span>Brands</span>', ['/product/index', 'category' => 2, 'featured' => 'featured'], ['class' => '']) ?></li>
                                        <?php
                                    } else {
                                        ?>
                                        <li class=""><?= Html::a('<span>Exclusive Brands</span>', ['/product/index', 'id' => $catag->category_code], ['class' => '']) ?></li>
                                        <li class=""><?= Html::a('<span>Brands</span>', ['/product/index', 'category' => 2, 'featured' => 'featured'], ['class' => '']) ?></li>
                                    <?php } ?>
