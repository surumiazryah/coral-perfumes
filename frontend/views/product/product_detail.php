    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 details">
                ...
                <?php if ($product_details->stock_availability == 1 && $product_details->stock > 0) { ?>
                    <h5 class="availability">availability:
                        <span>many in stock</span></h5>
                <?php } else { ?>
                   <h5 class="availability">availability:<span style="color: red">Not in stock</span>
                    </h5>
                <?php } ?>
                <div class="col-lg-12 col-md-12 hidden-sm hidden-xs pad-0">
                    ...
                    <?php } else { ?>
                        <div class="action">
                            <?= Html::a('add to cart', 'javascript:void(0)', ['class' => 'start-shopping']) ?>
